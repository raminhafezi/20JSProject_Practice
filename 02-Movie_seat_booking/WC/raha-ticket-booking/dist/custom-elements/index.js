...
const MyComponent = class extends HTMLElement {
    ...
    render() {
        return [
            h("div", { class: "movie-container" }, h("label", null, " Pick a Movie"), h("select", { name: "movie", id: "movie", onChange: event => this.movieChangeandler(event) }, this.movieDropDownElement())),
            ...
            h("div", { class: "container", ref: el => {
                    this.container = el;
                }, onClick: event => this.toggleBookedCssClass(event) }, h("div", { class: "screen" }, h("ul", { class: "ticketsSummary", ref: el => (this.screen = el) })), this.seatPositionElement()),
    ...
    static get style() { return rahaTicketBookingCss; }
};

const RahaTicketBooking = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"raha-ticket-booking",{"rows":[1538],"columns":[1538],"defaultSeatsPosition":[16],"currentSeatPosition":[1040],"selectedMovieIndex":[32],"bookedSeats":[32],"count":[32],"total":[32]}]);
...
export { RahaTicketBooking, defineCustomElements };
