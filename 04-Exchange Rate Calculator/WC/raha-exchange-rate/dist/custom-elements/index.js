...
const MyComponent = class extends HTMLElement {
  ...
  static get style() { return rahaExchangeRateCss; }
};

const RahaExchangeRate = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"raha-exchange-rate",{"image":[1],"exchangeText":[1,"exchange-text"],"currenyOneSymbol":[32],"currenyTwoSymbol":[32],"rate":[32],"amountOneValue":[32],"amountTwoValue":[32],"whoChanged":[32]}]);
...
export { RahaExchangeRate, defineCustomElements };
