...
const MyComponent = class extends HTMLElement {
  ...
  render() {
    return [
      ...
      h("div", { class: "container", onClick: this.catchRaisedEvent.bind(event) }, h("aside", null, h("button", { id: "add-user" }, "Add User \uD83E\uDD17"), h("button", { id: "double" }, "Double Money \uD83D\uDCB0"), h("button", { id: "show-millioners" }, "Show Only Millioners\uD83D\uDC8E"), h("button", { id: "sort" }, "Sort by Richest \uD83D\uDE32"), h("button", { id: "calculate-wealth" }, "Calculate entire Wealth \uD83D\uDC51")), h("main", { id: "main", ref: el => (this.main = el) }, h("h2", null, "Person", h("strong", null, "Wealth")))),
    ];
  }
  static get style() { return rahaRandomUsersCss; }
};

const RahaRandomUsers = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"raha-random-users",{"data":[32]}]);
...
export { RahaRandomUsers, defineCustomElements };
